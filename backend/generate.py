#!/usr/bin/env python3
"""One-shot generator: creates db.py, seed.py, server.py, schema.sql"""
import os
...
def w(name, text):
    ...
    os.makedirs(os.path.dirname(path) if os.path.dirname(path) else BACKEND, exist_ok=True)
...
print("Schema written. Run: python3 generate.py && python3 seed.py && python3 server.py")
