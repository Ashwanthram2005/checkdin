...
import { slotLabel, type Booking } from '../../data/bookings';
        ...
        <table className="w-full min-w-[1360px] border-collapse text-left">
          ...
          <tbody>
            {bookings.map((booking) => {
              ...
              const extensionPending = extension?.state === 'Pending Approval';
              ...
              return (
                <tr
                  ...
                  className={[
                  'cursor-pointer border-b border-neutral-100 transition-colors duration-150 ease-out last:border-0',
                  extensionPending ?
                  ...
                  <td className="whitespace-nowrap px-4 py-3.5">
                    <span className="text-[13px] font-semibold text-ink">#{booking.id}</span>
                    <p className="mt-0.5 text-[11.5px] text-ink-muted">{slotLabel(booking.room)}</p>
                  </td>
                  <td className="whitespace-nowrap px-4 py-3.5">
                  ...
                  <td className="whitespace-nowrap px-4 py-3.5 text-[13px] text-ink-soft">
                    ...
                    {extension?.state === 'Approved' &&
                    <span className="mt-0.5 block text-[11.5px] text-lime-700">
                        extended +{extension.extraHours}h
                      </span>
                    }
                  </td>
                  <td className="whitespace-nowrap px-4 py-3.5 text-[13px] text-ink-soft">
                  ...
                  <td className="px-4 py-3.5">
                    ...
                    <span className="flex flex-col items-start gap-1.5">
                      ...
                      <ExtensionCountdown
                        ...
                        onExpire={() => onExtensionExpire(booking.id)}
                        compact />
