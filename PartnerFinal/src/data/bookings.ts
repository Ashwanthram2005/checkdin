...
export type BookingSource = 'Checkdin App' | 'Checkdin Web' | 'Walk-in' | 'Corporate';
...
export type ExtensionState = 'Pending Approval' | 'Approved' | 'Rejected' | 'Expired';
...
export type BookingExtension = {
  ...
  requestedAt: string;
  /** Seconds left in the 5-minute approval window. */
  respondWithin: number;
  state: ExtensionState;
  rejectionReason?: string;
  /** Operational capacity read for the requested window — never room-level. */
  capacity: {available: boolean;note: string;};
};

/**
 * Checkdin sells slots, not specific rooms — the hotel allocates a room internally.
 * Every surface shows the slot category, never a room number.
 */
export const slotLabel = (room: string) => `${room.replace(/\s*\d+$/, '')} slot`;
...
export const bookings: Booking[] = [
{
  id: 'CHK123456',
  guest: 'Rahul Sharma',
  phone: '+91 98404 78210',
  email: 'rahul.sharma@gmail.com',
  room: 'Deluxe Room 204',
  roomType: 'Deluxe Room',
  bookedOn: '17 Aug 2026, 10:02 AM',
  ...
  extension: {
    ...
    capacity: { available: true, note: '14 of 18 allocated slots sold in the 4–7 PM window.' }
  },
  idProof: 'Aadhaar • verified at desk',
  specialRequests: 'Working from the room, needs a quiet floor.',
  internalNote: '',
  timeline: [
  { id: 't1', label: 'Booking requested', time: '17 Aug, 10:02 AM', done: true },
  { id: 't2', label: 'Payment received', time: '17 Aug, 10:03 AM', done: true },
  { id: 't3', label: 'Checked in', time: '17 Aug, 1:04 PM', done: true },
  { id: 't4', label: 'Extension requested (+3 hours)', time: '17 Aug, 2:15 PM', done: true },
  { id: 't5', label: 'Awaiting extension approval', time: 'Expires in 5m', done: false }]
...
},
{
  ...
  extension: {
    extraHours: 3,
    currentCheckout: '10:00 PM',
    requestedCheckout: '1:00 AM',
    additionalRevenue: 450,
    requestedAt: '7:32 PM',
    respondWithin: 0,
    state: 'Approved',
    capacity: { available: true, note: 'Capacity was available when approved.' }
  },
  idProof: 'Aadhaar • verified on app',
...
},
{
  ...
  extension: {
    extraHours: 3,
    currentCheckout: '11:00 PM',
    requestedCheckout: '2:00 AM',
    additionalRevenue: 450,
    requestedAt: '9:41 PM',
    respondWithin: 0,
    state: 'Rejected',
    rejectionReason: 'Housekeeping Requirement',
    capacity: { available: true, note: 'Capacity was free but housekeeping was scheduled.' }
  },
...
},
{
  ...
  extension: {
    extraHours: 3,
    currentCheckout: '6:00 AM',
    requestedCheckout: '9:00 AM',
    additionalRevenue: 450,
    requestedAt: '4:48 AM',
    respondWithin: 132,
    state: 'Pending Approval',
    capacity: {
      available: false,
      note: '17 of 18 allocated slots already sold in the morning window.'
    }
  },
  idProof: 'Aadhaar • verified at desk',
...
},
{
  ...
  extension: {
    extraHours: 6,
    currentCheckout: '2:00 PM',
    requestedCheckout: '8:00 PM',
    additionalRevenue: 850,
    requestedAt: '12:04 PM',
    respondWithin: 0,
    state: 'Expired',
    capacity: { available: true, note: 'Capacity was available for the whole window.' }
  },
  idProof: 'Aadhaar • verified on app',
