...
import { pastBookings, type BookingRecord, type BookingStatus } from '../data/bookings';
...
export function Bookings() {
  ...
  const live = useMemo<BookingRecord[]>(() => {
    ...
    const hotel = getHotel(draft.hotelId);
    if (!hotel) return [];
    return [
    {
      id: 'live',
      ...
      guests: draft.guests,
      amount: priceBreakdown(hotel.rates[draft.duration], draft.duration).total,
      status: 'ongoing',
