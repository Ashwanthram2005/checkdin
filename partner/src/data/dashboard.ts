...
{ label: 'Total Rooms', count: 25, tone: 'neutral' as const },
{ label: 'Available', count: 8, tone: 'lime' as const },
{ label: 'Occupied', count: 14, tone: 'forest' as const },
{ label: 'Cleaning', count: 2, tone: 'blue' as const },
{ label: 'Maintenance', count: 1, tone: 'red' as const }];
