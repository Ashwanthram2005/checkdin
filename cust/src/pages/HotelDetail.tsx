...
import {
  ...
  UsersIcon } from
'lucide-react';
import { galleryFor, loadHotel } from '../data/hotels';
  ...
  if (loading) {
    return (
      <div className="mx-auto w-full max-w-[1360px] px-5 py-24 text-center lg:px-8">
        <div className="h-8 w-48 mx-auto animate-pulse rounded bg-surface" />
        <div className="h-4 w-64 mx-auto mt-4 animate-pulse rounded bg-surface" />
      </div>
    );
  }
